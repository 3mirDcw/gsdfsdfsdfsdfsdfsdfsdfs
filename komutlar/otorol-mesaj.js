...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:kabul:802835416075862019>  **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
  ...
  if(mesaj.length < 5) return message.channel.send('<a:kabul:802835416075862019>  **Sayaç Hoşgeldin Mesaj Sistemi İçin En Az 5 Karakter Belirtebilirsin!**\n `**__Örnek__**: `otorol-mesaj -uye- Hoşgeldin! senle beraber -uyesayisi- Kişiyiz!`')
  
 message.channel.send('<a:kabul:802835416075862019> **Oto Rol mesajı** `'+mesaj+'` **Olarak ayarlandı!**') 
