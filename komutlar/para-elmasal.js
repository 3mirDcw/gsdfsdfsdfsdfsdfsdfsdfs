...
//  let sigara = 1
  ...
  let düşE = 49
    ...
    if (altın < elmaspara*miktar) {
      message.channel.send(`<a:reddededee:763326997266038794> ${miktar} elmas alabilmek için yeterli altın görünmüyor. \n Gerekli altın **${miktar*elmaspara} **`)
     ...
     .setColor('RANDOM')
     .setDescription(`<a:dorudoru:763326993135566848> Başarıyla marketten **${miktar}** elmas aldınız\n Hesabınızdan eksilen altın miktarı: **${miktar*elmaspara}**`)
     .setTimestamp()
