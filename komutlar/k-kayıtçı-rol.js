...
.setColor('BLACK')
.setDescription(`<a:hg:768790537108062248> Sunucu İçin Ayarladığınız Kayıtçı Rol Başarıyla Sıfırlandı ! `)
...
.setColor('BLACK')
.setDescription(`<a:by:768790537108062248> Ayarlayacağınız Kayıtçı Rolü Belirtiniz ! `)
...
.setColor('BLACK')
.setDescription(`<a:hg:768790537108062248> Kayıt Edecek Rol Başarıyla ${rol} Olarak Ayarlandı ! `)
.setThumbnail(client.user.avatarURL)
.setFooter(`Komut ${message.author.tag} Tarafından Kullanıldı ! `)
