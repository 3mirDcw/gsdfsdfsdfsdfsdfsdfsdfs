...
.setColor('BLACK')
.setDescription(`<a:hg:768790537108062248> Sunucu İçin Ayarladığınız Erkek Rolü Başarıyla Sıfırlandı !`)
...
.setColor('BLACK')
.setDescription(`<a:by:768790537108062248> Ayarlayacağınız Erkek Rolünü Belirtiniz ! `)
.setThumbnail(client.user.avatarURL)
.setFooter(`Komut ${message.author.tag} Tarafından Kullanıldı ! `)
...
.setColor('BLACK')
.setDescription(`<a:hg:768790537108062248> Erkek Rolü Başarıyla ${rol} Olarak Ayarlandı ! `)
.setThumbnail(client.user.avatarURL)
.setFooter(`Komut ${message.author.tag} Tarafından Kullanıldı ! `)
